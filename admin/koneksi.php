...
$surat_balasan_pkl_count = mysqli_fetch_array(mysqli_query($koneksi, "SELECT COUNT(*) as count FROM surat_balasan"))['count'];
...
$laporan_pendaftaran_magang_count = mysqli_fetch_array(mysqli_query($koneksi, "SELECT COUNT(*) as count FROM pendaftaran_magang"))['count'];
?>